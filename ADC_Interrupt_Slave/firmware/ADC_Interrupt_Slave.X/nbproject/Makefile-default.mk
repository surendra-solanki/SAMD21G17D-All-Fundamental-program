...
FINAL_IMAGE=${DISTDIR}/ADC_Interrupt_Slave.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/ADC_Interrupt_Slave.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
